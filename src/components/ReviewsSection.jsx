        ...
        <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="text-5xl md:text-6xl font-display text-brand-cream leading-tight">
              Testigos de
              <br />
              <span className="text-stone-100 italic">nuestra tradición</span>
            </h2>
          </div>

          <p className="text-stone-400 text-lg md:text-right max-w-sm font-light">
            Más de 40 años forjando amistades a través del fuego. Esto es lo que
            dicen quienes nos eligen.
          </p>
        </header>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-brand-cream tracking-wide">
                      {r.name}
                    </h3>
